...
const TIMELINE = [
  { year: "2025", label: "Became operational", detail: "Began programme work in Makurdi, Benue State" },
  { year: "Jun 2026", label: "Formally registered", detail: "Incorporated Trustee, CAC IT No. 9614146" },
];
      ...
      <div className="relative mx-auto grid max-w-6xl items-start gap-16 lg:grid-cols-[1fr_1.1fr]">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-foreground/60">About CVI</span>
          </div>
          <h2
        ...
        >
          <div className="relative h-64 w-full overflow-hidden rounded-lg sm:h-80">
            <Image src="/img10.png" alt="CVI community programme" fill className="object-cover" />
          </div>
          ...
          <div className="mt-10 space-y-8 border-l border-border pl-8">
            {TIMELINE.map((t, i) => (
              ...
              >
                ...
                <div className="mt-0.5 text-base font-medium text-foreground">{t.label}</div>
